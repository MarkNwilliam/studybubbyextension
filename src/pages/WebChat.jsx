...
const WebChat = () => {
      ...
      try {
        ...
        if (available !== "no") {
          const session = await ai.languageModel.create({
            systemPrompt: "You are a helpful assistant that can answer questions about a specific webpage summary. Provide concise, relevant answers based on the given context.",
  ...
  const getCurrentPageContent = async () => {
    ...
    try {
      ...
      if (storedSummary) {
        ...
        let [scriptResult] = await new Promise((resolve) => 
      ...
      if (scriptResult?.result) {
        let content = scriptResult.result;
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const fullPrompt = `Webpage data:\n${webpagecontent}\n\nUser Question: ${input}\n\nProvide a concise, relevant answer based strictly on the webpage data.`;
